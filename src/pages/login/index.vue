        ...
        <div :class="{ container: true, 'sign-up-model': vari }">
            <div class="inner-left-container">
                <div class="login-content">
                    <h1 style="color: white;">GDOU-OWC</h1>
                    <a-button type="primary" @click="onClick" size="large">去注册</a-button>
                </div>
            ...
            <div class="inner-right-container">
                <div class="register-content">
                    <h1 style="color: white;">GDOU-OWC</h1>
                    <a-button type="primary" @click="onClick" size="large">去登录</a-button>
                </div>
...
import { ref } from 'vue'
import login from '@/pages/login/components/loginForm.vue'
import register from '@/pages/login/components/registerForm.vue'
const onClick = () => {
